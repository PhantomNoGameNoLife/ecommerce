        ...
        <section className="mb-10 flex flex-col md:flex-row">
            <div className="w-full md:w-2/3 rounded-s-xl">
                <Swiper
                    ...
                    loop >
                    <SwiperSlide><div className="h-[300px] md:h-[400px] w-full relative"><Image className="md:object-cover rounded-xl md:rounded-e-none md:rounded-s-xl" fill priority src={slide1} alt="slide 1" /></div></SwiperSlide>
                    <SwiperSlide><div className="h-[300px] md:h-[400px] w-full relative"><Image className="md:object-cover rounded-xl md:rounded-e-none md:rounded-s-xl" fill priority src={slide2} alt="slide 2" /></div></SwiperSlide>
                    <SwiperSlide><div className="h-[300px] md:h-[400px] w-full relative"><Image className="md:object-cover rounded-xl md:rounded-e-none md:rounded-s-xl" fill priority src={slide3} alt="slide 3" /></div></SwiperSlide>
                </Swiper>
            </div>
